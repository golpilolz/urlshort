 ...
 */
final class Version20220226185355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE redirection (id INT NOT NULL, link TEXT NOT NULL, token VARCHAR(8) NOT NULL, PRIMARY KEY(id))');
